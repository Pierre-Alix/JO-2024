...
<body>
    ...
    <main>
        ...
        try {
            ...
            $query = "SELECT nom_epreuve, nom_sport, resultat, nom_athlete, prenom_athlete, nom_genre, nom_pays FROM EPREUVE
            INNER JOIN SPORT ON EPREUVE.id_sport = SPORT.id_sport
            INNER JOIN PARTICIPER ON EPREUVE.id_epreuve = PARTICIPER.id_epreuve
