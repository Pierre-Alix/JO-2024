...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($statementCheck->rowCount() > 0) {
            ...
            $query = "UPDATE LIEU SET nom_lieu = :nomLieu, adresse_lieu = :adresseLieu, ville_lieu = :villeLieu, cp_lieu = :cpLieu WHERE id_lieu = :idLieu";
...
try {
    $queryLieu = "SELECT nom_lieu, adresse_lieu, ville_lieu, cp_lieu FROM LIEU WHERE id_lieu = :idLieu";
